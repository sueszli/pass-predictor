420 endpoints in total

docs:

- https://tuwel.tuwien.ac.at/webservice/wsdoc.php?id=10151
...
report_insights_set_fixed_prediction (Deprecated)
report_insights_set_notuseful_prediction (Deprecated)
